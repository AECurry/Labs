...
func add(_ a:Int?, _ b: Int?) -> Int? {
    guard let number1 = a, let number2 = b else {
        return nil
    }
...
if let sum1 = add(6,8) {
    ...
    print("Sum 1: Invalid input.")
}

if let sum2 = add(nil, 7) {
    print("Sum 2: \(sum2)")
} else {
    print("Sum 2: invlaid input.")
}
/*:
...
if let user = result {
    ...
    print("Failed ot create user - one or more fields were nil.")
}
/*:

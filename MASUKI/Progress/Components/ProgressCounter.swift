...
struct ProgressCounter: View {
    @AppStorage("progressCounterTopPadding") private var topPadding: Double = 40 // ADDED SPACING HERE
    ...
    var body: some View {
        ...
        .padding(.top, topPadding) // This component controls its own top spacing

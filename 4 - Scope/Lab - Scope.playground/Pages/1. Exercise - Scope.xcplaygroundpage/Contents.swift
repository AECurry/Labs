...
//This will cause a compiler error becaue foo is declared inside the loop and does not exist outside of it.
//print(foo)
...
greeting(greeting: "Hi there", name: "Elizabeth")
greeting(greeting: nil, name: "Alexa")

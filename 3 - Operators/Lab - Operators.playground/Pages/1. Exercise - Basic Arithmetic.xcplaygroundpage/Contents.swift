...
//writning "Double" makes sure that result comes out in decimal form instead of a whole number
...
//I think I can use the remainder operator to know if my answer is even or odd by looking at the answer and if it is 0 than the interger is even and if I get a 1 than the interger is odd.

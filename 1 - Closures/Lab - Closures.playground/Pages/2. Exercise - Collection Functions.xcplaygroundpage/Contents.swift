 ...
 */
func forwards(name1: String, name2: String) -> Bool { print("Comparing \(name1) and \(name2)")
    return name1 < name2

}

let myNames = ["Gary", "Jane", "Rick", "Beth"]
let sortedNames = names.sorted(by: forwards)
print(sortedNames)
...
let names = ["Burnett", "Darlene", "Amy", "Ann", "Shallan", "Sara", "Jordan", "Joseph"]
...
let sortedColletion3 = names.sorted(by: {$0 < $1})
print(sortedColletion3)

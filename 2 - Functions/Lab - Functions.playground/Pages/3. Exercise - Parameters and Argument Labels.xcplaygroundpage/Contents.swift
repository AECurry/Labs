...
func introduction(name: String, home: String, age: Int) {
    print("Hello, my name is \(name). I am \(age) years old, and I live in \(home).")
}
 introduction(name: "Ann-Elaine", home: "Lehi", age: 42)

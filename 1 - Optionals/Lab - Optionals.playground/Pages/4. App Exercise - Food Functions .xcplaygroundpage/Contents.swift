...
if let breakfastMeal = getMeal(mealName: "Breakfast") {
    print("Breakfast logged: \(breakfastMeal.food), Calories: \(breakfastMeal.calories)")
} else {
    print("Breakfast not logged yet.")
}

if let lunchMeal = getMeal(mealName: "Lunch") {
    print("Lunch logged: \(lunchMeal.food), Calories: \(lunchMeal.calories)")
} else {

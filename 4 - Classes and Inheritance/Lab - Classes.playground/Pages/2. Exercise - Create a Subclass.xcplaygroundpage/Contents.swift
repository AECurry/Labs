...
class FighterXWing: Spaceship {
    var laserDamage: Int = 10
    
    func fireLaser() {
        print("\(name) fired a laser doing \(laserDamage).")
    }
}
...
let destroyer = FighterYWing()
destroyer.name = "Lady Mary"
...
//Falcon is an instance of Spaceship and Spaceship does not have a "weapon" property. Only Fighter subclasses have a "weapon" property.

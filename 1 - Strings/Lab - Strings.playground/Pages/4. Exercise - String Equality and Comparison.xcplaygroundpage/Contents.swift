 ...
 */
let nameInCaps = "Ann-Elaine Curry"
let name = "ann-elaine curry"
 ...
 */
    if name.lowercased() == "Ann-Elaine Curry".lowercased() {
        print("Insert lowercased version of \(nameInCaps) here and insert lowercased version of \(name) here.")
    } else {
    print("Insert lowercased version of \(nameInCaps) and Inserst lowercased version of \(name) here are not the same.")
}
...
let count = name.count
        ...
        if name.count < 14 {
            print("Oops. You missed a letter please try again.")
        }
/*:

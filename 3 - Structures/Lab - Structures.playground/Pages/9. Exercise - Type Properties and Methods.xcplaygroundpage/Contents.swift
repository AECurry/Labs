...
struct User {
    ...
    static var currentUser: User = User(userName: "AnnGrace", email: "anngrace@example.com", age: 28)
...
print("Now the current user is \(User.currentUser.userName), email: \(User.currentUser.email), age: \(User.currentUser.age)")
/*:

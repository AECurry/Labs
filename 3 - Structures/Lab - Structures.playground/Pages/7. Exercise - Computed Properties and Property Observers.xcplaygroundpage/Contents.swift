...
let myRectangle = Rectangle(width: 7, height: 14)
...
var myHeight = Height(heightInInches: 55)
print("Initial: \(myHeight.heightInInches) inches,  \(myHeight.heightInCentimeters) cm")

myHeight.heightInInches = 77
print("After updating inches: \(myHeight.heightInInches) inches, \(myHeight.heightInCentimeters) cm")

myHeight.heightInCentimeters = 188
print("After updating cm: \(myHeight.heightInInches) inches, \(myHeight.heightInCentimeters) cm")
/*:

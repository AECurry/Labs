...
favoriteBook.title = "The Giver of Stars"
favoriteBook.author = "Jojo Moyes"
favoriteBook.pages = 432
favoriteBook.price = 12.99

print("My favorite book is \(favoriteBook.title) written by \(favoriteBook.author). It has \(favoriteBook.pages) and costs \(favoriteBook.price).")
/*:
